...
| Conversion-surface illustration, no photography | `ShaderField` (`wash`, `motes`, `ripple`) or `LightOrb` | a CSS gradient, a stock 3D file, three.js, anything on an engagement surface |
