...
- Numbers in tables right-align to the trailing edge (see `typography` for tabular figures); text left-aligns to the leading edge.
...
- One primary action per view (see `colors` for how color enforces this).
