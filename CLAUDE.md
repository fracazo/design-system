...
- `studio/`: recording kit for the X series (The System Proposes). Vite app
  that renders the real components on an illustrative cream / rose skin.
  Not in the published tarball. `pnpm build` then `pnpm studio`.
